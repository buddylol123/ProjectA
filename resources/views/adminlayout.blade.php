    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
                <li><a href="{{URL::to("/thongtinadmin", Auth::user()->id)}}"><i class=" fa fa-suitcase"></i>Profile</a></li>
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
				...
				<li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to("/thongtinkhachhang")}}">Xem Thông Tin</a></li>
                    </ul>
                </li>
				@can('edit ')
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{URL::to('/all-nhanvien')}}">Danh sách nhân viên</a></li>
                    </ul>
                </li>
				@endcan
                <li class="sub-menu">
				...
				<li class="sub-menu">
                    <a href="javascript:;">
                        <i class="fa fa-book"></i>
                        <span>Danh mục hóa đơn</span>
                    </a>
                    <ul class="sub">
						<li><a href="">Xử lý hóa đơn</a></li>
						<li><a href="">Liệt kê hóa đơn</a></li>
